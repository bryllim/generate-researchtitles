...
export default function researchTitle() {
  ...
  return (
    <>
      ...
      <Container maxW={'3xl'} borderWidth="1px" borderRadius="lg" mt="30" p="30">
        <Stack
          as={Box}
          textAlign={'center'}
          ...
          <Heading
            ...
            lineHeight={'110%'}>
            Research Title <Text as={'span'} color={'green.400'}>Generator </Text>
          </Heading>
          <Text color={'gray.500'}>
            This tool randomly generates research title ideas for your reference or inspiration.
            <br />Currently, the generated titles are for <strong>computer-related</strong> majors. 
          ...
          <Text color={'gray.500'}>
            Made with 💚 by{" "}
            <Link color="teal.500" href="https://bryllim.com/" fontWeight={700}>
              Bryl Lim
            </Link>
            <br />
            <Badge>next.js</Badge>
